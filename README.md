...
|------|---------|-------------|------------|
| 2026 | **[Anime Pipeline v2](https://github.com/tylerana/anime-pipeline)** | A Dockerized ELT pipeline that ingests MyAnimeList data via the Jikan API, loads it into Postgres, and models analytics-ready tables using dbt. | ![ELT](https://img.shields.io/badge/ELT-Pipeline-blue) ![dbt](https://img.shields.io/badge/dbt-Core-orange) ![Postgres](https://img.shields.io/badge/Postgres-Database-blue) ![Docker](https://img.shields.io/badge/Docker-Compose-blue)
